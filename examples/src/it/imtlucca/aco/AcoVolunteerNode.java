 ...
 *
 */
public class AcoVolunteerNode extends VolunteerNode {
	...
	public AcoVolunteerNode(String id, Properties params,
			ArrayList<Resource> resources) throws InvalidParamsException {
		super(id, params, resources);
		System.out.println("Aco Volunteer Node constructor called...");
