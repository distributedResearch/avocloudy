package it.imtlucca.aco.infrastructureLayer.dc;
 ...
 *
 */
public class DataCenterAcoNodeStartupCheckEvent extends
		AbstractDataCenterNodeStartupCheckEvent {

	public DataCenterAcoNodeStartupCheckEvent(String id, Properties params,
